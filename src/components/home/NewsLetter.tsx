...
const NewsLetter = () => {
  return (
    <div className="bg-[#d89e5b] w-full">
      <div className="w-full max-w-7xl py-12 mx-auto flex flex-col lg:flex-row gap-8 px-6 min-h-[40vh] lg:h-[40vh]">
        <div>
          ...
          <div className="bg-[#9e794f] flex flex-col lg:flex-row gap-4 mt-6 border-[0.8px] border-[#C5D5FD] border-opacity-20 py-2 rounded px-4 hover:border-white">
            <input
              type="text"
