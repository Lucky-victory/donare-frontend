...
export const CAMPAIGN_MANAGER_ABI =  [
    ...
    },
    {
      ...
      "name": "campaignIdToChainIdToSpokeDonationData",
      "outputs": [
        {
          "internalType": "uint256",
          "name": "raisedFunds",
...
export const CROSS_CHAIN_DAO_ABI = [
    {
      "inputs": [
        {
      ...
      "outputs": [
        {
          ...
          "internalType": "struct CrossChainDAO.ProposalData[]",
          "name": "",
          "type": "tuple[]"
        }
      ],
    ...
    },
    {
      ...
      "name": "getParticularProposalData",
      "outputs": [
        {
          "components": [
            {
...
export const DAO_SATELLITE = []
export const GOVERNOR_TOKEN_ABI = []


export const GOVERNANACE_TOKEN_ADDR = '0xD7F2bbC67cBC880F8f7C99d9F24dE7bBe3243C4C'
export const DAO_ADDR = '0xeE72F500671d7F8439c0b3B3c6a472CdA4BCb560'
export const CAMPAIGN_MANAGER_ADDR = '0xfaEAc401400A66262CBBe90A37eDAB8CE48B3Ab4'
export const CAMPAIGN_SATELLITE_ADDR = '0xc514d8Fd3052E3D2aE793c1e95d4EFdA8Bb05d83'
export const DAO_SATELLITE_ADDR = '0xc7FFF6CcC69249E89f3aeE092B1713ED2c65dE08'
